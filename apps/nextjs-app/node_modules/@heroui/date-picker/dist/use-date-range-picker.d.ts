...
declare function useDateRangePicker<T extends DateValue>({ as, label, isInvalid: isInvalidProp, description, startContent, endContent, selectorIcon, errorMessage, className, classNames, ...originalProps }: UseDateRangePickerProps<T>): {
    ...
    classNames: (SlotsToClasses<"base" | "separator" | "selectorIcon" | "popoverContent" | "selectorButton" | "calendar" | "calendarContent" | "timeInputLabel" | "timeInput" | "bottomContent" | "timeInputWrapper"> & SlotsToClasses<"base" | "description" | "label" | "errorMessage" | "input" | "segment" | "helperWrapper" | "inputWrapper" | "innerWrapper">) | undefined;
